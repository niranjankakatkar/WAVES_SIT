					...
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="../Dashboard">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Brand List
							</p>
						</div>
						<!-- <div>
									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table">
											...
											<tbody>
												...
												<?php
												$i=1;
												$sql = "SELECT * FROM contact_us where brand_flag='1' ORDER BY id DESC";
							...
							<div class="modal-content">
								<form method="POST">
									<div class="modal-header px-4">
										<h5 class="modal-title" id="exampleModalCenterTitle">Brand Info
										</h5>
									</div>
