								...
								<div class="card-body">
									<div class="table-responsive">
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
											<?php
												$sql = "SELECT * FROM order_master where admin_flag='0' ORDER BY id DESC";
												...
												<?=givedata($conn,"user_master","token_key",$userKey,"email")?></td>
													...
													<td >
													 ...
													 <button class="mb-2 mr-2 badge badge-success" onclick="get_otheruserdata(<?= $row['id'] ?>)"
																		...
																		data-bs-target="#accept"><b>Accept Order</b>  </button>
														<button class="mb-2 mr-2 badge badge-danger"  onclick="get_otheruserdata(<?= $row['id'] ?>)"
																		data-bs-toggle="modal"
																		data-bs-target="#decline1"><b>Decline Order</b> </button>
														<button class="mb-2 mr-2 badge badge-primary" onclick="window.location.href='view.php?id=<?=$row['id']?>'"><b>View Order</b> </button>
													</td>
