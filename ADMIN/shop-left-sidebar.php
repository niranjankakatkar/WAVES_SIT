                    ...
                    <div class="left-box wow fadeInUp">
                        <div class="shop-left-sidebar">
                            ...
                            <div class="filter-category">
                                ...
                                <ul>
                                    <li>
                                        <a href="javascript:void(0)">Food Box</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">Fruit Box</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">Burger Box</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">Meal Box</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">White Deli Box</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show">
                                        <div class="accordion-body">
                                            ...
                                            <ul class="category-list custom-padding custom-height">
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        ...
                                                        <label class="form-check-label" for="fruit">
                                                            <span class="name">Food Boxs</span>
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        ...
                                                        <label class="form-check-label" for="cake">
                                                            <span class="name">Burger Box</span>
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        ...
                                                        <label class="form-check-label" for="behe">
                                                            <span class="name">Meal Deli Box</span>
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        <input class="checkbox_animated" type="checkbox" id="Food Box">
                                                        <label class="form-check-label" for="Food Box">
                                                            <span class="name">Coverd Box</span>
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        ...
                                                        <label class="form-check-label" for="beauty">
                                                            <span class="name">Cold Food Packaging</span>
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        ...
                                                        <label class="form-check-label" for="pets">
                                                            <span class="name">Bags & Sheets</span>
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        ...
                                                        <label class="form-check-label" for="egg">
                                                            <span class="name">Drinking Cups</span>
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 m-0 category-list-box">
                                                        ...
                                                        <label class="form-check-label" for="food">
                                                            <span class="name">Customerized Bags</span>
                                                            <span class="number">(30)</span>
                                                        </label>
                                                    </div>
                                                </li>
                            ...
                            <div class="product-box-3 h-100 wow fadeInUp">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">Standard Kraft Food Box - 500pk</h5>
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="assets/images/cake/product/3.jpg"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">9" x 6" Bagasse Lunch Box - 250pk</h5>
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="assets/images/cake/product/12.jpg"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">Standard Kraft Burger Box - 500pk</h5>
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="assets/images/cake/product/12.avif"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left-thumbnail.html">
                                            <img src="assets/images/cake/product/10.jpg"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">No.3 Leak Proof Kraft Deli Box - 180pk</h5>
                                        </a>
                            ...
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.25s">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">9" 3 Compartment Bagasse Meal Box - 200pk</h5>
                                        </a>
                            ...
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.35s">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">Large Kraft Food Box - 250pk</h5>
                                        </a>
                            ...
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.4s">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">9" Bagasse Clamshell Meal Box - 200pk</h5>
                                        </a>
                            ...
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.45s">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">No.4 Leak Proof Kraft Deli Box - 160pk</h5>
                                        </a>
                            ...
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.55s">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">No.1 Leak Proof Kraft Deli Box - 450pk</h5>
                                        </a>
                            ...
                            <div class="product-box-3 h-100 wow fadeInUp" data-wow-delay="0.65s">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">Food Box</span>
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="name">No.8 Leak Proof Kraft Deli Box - 300pk</h5>
                                        </a>
